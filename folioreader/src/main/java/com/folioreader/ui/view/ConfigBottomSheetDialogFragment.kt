...
class ConfigBottomSheetDialogFragment : BottomSheetDialogFragment() {
    ...
    val myView get() = super.getView()!!

    val container get() = myView.findViewById<View>(R.id.container)
    val view_config_font_size_seek_bar get() = myView.findViewById<SeekBar>(R.id.view_config_font_size_seek_bar)
    private fun initViews() {
        ...
        val view_config_ib_day_mode = myView.findViewById<ImageButton>(R.id.view_config_ib_day_mode)
        val view_config_ib_night_mode = myView.findViewById<ImageButton>(R.id.view_config_ib_night_mode)
        if (isNightMode) {
    ...
    private fun inflateView() {
        ...
        if (config.allowedDirection != Config.AllowedDirection.VERTICAL_AND_HORIZONTAL) {
            myView.findViewById<View>(R.id.view5).visibility = View.GONE
            myView.findViewById<View>(R.id.buttonVertical).visibility = View.GONE
            myView.findViewById<View>(R.id.buttonHorizontal).visibility = View.GONE
        }
    ...
    val view_config_font_spinner get() = myView.findViewById<Spinner>(R.id.view_config_font_spinner);
